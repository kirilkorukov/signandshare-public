...
<head>
    ...
    <title>Education - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Education - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/education/" />
    <meta property="og:title" content="Education - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        ...
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Education"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Education" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
