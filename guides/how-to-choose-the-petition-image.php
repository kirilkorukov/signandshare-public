...
<head>
    ...
    <title>How to Choose The Petition's Image - Sign & Share</title>
    ...
    <meta name="twitter:title" content="How to Choose The Petition's Image - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/guides/how-to-choose-the-petition-image" />
    <meta property="og:title" content="How to Choose The Petition's Image - Sign & Share" />
...
<main class="petition-page-wrapper">
    <div class="left-column left">
        <div class="about-title">How to Choose The Petition's Image</div>
        <p class="about-text">Едно от предимствата на онлайн петициите е че не трябва да обикаляш улиците за да събираш подписи.  Но как точно да съберем нужните подписи за да спечелим нашата кампания? Споделяне на петицията в социалните мрежи, изпращане на емайл на приятелите ти са само част от начините да събереш необходимите подписи to make a difference. Below are our top tips to spread the word about your petition and get more signatures:</p>
        <hr class="about-hr">
        <div class="about-mini-title">Share Your Petition on Facebook</div>
        <p class="about-text"></p>
        <hr class="about-hr">
        <div class="about-mini-title">Tweet Your Petition</div>
        <p class="about-text">Tweet your petition to Twitter and make sure to include any user handles that will help make your target see your messages and any trending or topical hashtags that will help people with similar interest notice your tweet. With only 140 characters available, you can't afford to use 20-30 characters just on the link to the petition. Free link-shortener websites like <a target="_blank" href="https://bitly.com/">bit.ly</a> work great. Keep your tweet short and use Also, post frequent updates about your petition. </p>
        <hr class="about-hr">
