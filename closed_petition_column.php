    <div class="right-column right">
        <div class="victory-right-column-image"><img alt src="/images/padlock.png" width="40px"></div>
        <div class="victory-right-column-title">Petition Closed</div>
        <div class="victory-right-column-text">This petition is now closed. You can still make a difference by signing other petitions today.</div>
