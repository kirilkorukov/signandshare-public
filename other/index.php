...
<head>
    ...
    <title>Other petitions - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Other petitions - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/other/" />
    <meta property="og:title" content="Other petitions - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        ...
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Other"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Other" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
