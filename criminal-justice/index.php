...
<head>
    ...
    <title>Criminal Justice - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Criminal Justice - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/criminal-justice/" />
    <meta property="og:title" content="Criminal Justice - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        <div class="category-title">Criminal Justice</div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Criminal Justice"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Criminal Justice" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
