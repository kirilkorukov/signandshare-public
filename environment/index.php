...
<head>
    ...
    <title>Environment - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Environment - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/environment/" />
    <meta property="og:title" content="Environment - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        ...
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Environment"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Environment" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
