...
<head>
    ...
    <title>Human rights - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Human rights - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/human-rights/" />
    <meta property="og:title" content="Human rights - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        <div class="category-title">Human Rights</div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Human Rights"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Human Rights" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
