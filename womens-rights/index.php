...
<head>
    ...
    <title>Women's rights - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Women's rights - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/womens-rights/" />
    <meta property="og:title" content="Women's rights - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        <div class="category-title">Women's Rights</div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Women\'s Rights"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Women\'s Rights" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
