...
<head>
    ...
    <title>Sustainable food - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Sustainable food - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/sustainable-food/" />
    <meta property="og:title" content="Sustainable food - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        <div class="category-title">Sustainable Food</div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "Sustainable Food"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "Sustainable Food" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
