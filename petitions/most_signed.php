...
<head>
    ...
    <meta property="og:url" content="https://www.signandshare.org/petitions/most_signed" />
    ...
    <div class="left-column left">
        <div class="petition-sort">
            <ul class="petition-sort-ul left" >
                ...
                <a href="most_signed"><li class="petition-sort-selected">Most signed</li></a>
        ...
        <?php
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition ORDER BY currentSupporters DESC LIMIT ' . $start . ',' . $per_page . '';
            ...
            if($pages > 1 && $next <= $pages){
                echo ' <div class="pagination">
                        <a href="most_signed?page=' . $next . '"><div class="pagination-block">Load More</div></a>
                    </div>';
            }
        ?>
    </div>
