...
<head>
    ...
    <title>Browse petitions - Sign & Share</title>
    ...
    <meta name="twitter:title" content="Browse petitions - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/petitions/recent" />
    <meta property="og:title" content="Browse petitions - Sign & Share" />
...
<main class="index-page-wrapper">
    <div class="left-column left">
        <div class="petition-sort">
            <ul class="petition-sort-ul left" >
                <a href="featured"><li style="margin-left: 0px;">Featured</li></a>
                <a href="most_signed"><li>Most signed</li></a>
                <a href="recent"><li class="petition-sort-selected">Recent</li></a>
            </ul>
        </div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
            ...
            if($pages > 1 && $next <= $pages){
                echo ' <div class="pagination">
                        <a href="recent?page=' . $next . '"><div class="pagination-block">Load More</div></a>
                    </div>';
            }
        ?>
    </div>
