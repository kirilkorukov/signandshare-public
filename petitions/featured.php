...
<head>
    ...
    <meta property="og:url" content="https://www.signandshare.org/petitions/featured" />
    ...
    <div class="left-column left">
        <div class="petition-sort">
            <ul class="petition-sort-ul left" >
                <a href="featured"><li style="margin-left: 0px;" class="petition-sort-selected">Featured</li></a>
        ...
        <?php
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE featured = 1 ORDER BY date DESC';
            ...
            if($pages > 1 && $next <= $pages){
                echo ' <div class="pagination">
                        <a href="featured?page=' . $next . '"><div class="pagination-block">Load More</div></a>
                    </div>';
            }
        ?>
    </div>
