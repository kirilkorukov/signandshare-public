...
<head>
    ...
    <title>LGBT issues - Sign & Share</title>
    ...
    <meta name="twitter:title" content="LGBT issues - Sign & Share">
    ...
    <meta property="og:url" content="https://www.signandshare.org/lgbt-issues/" />
    <meta property="og:title" content="LGBT issues - Sign & Share" />
...
<main class="index-page-wrapper">
    ...
    <div class="left-column left">
        <div class="category-title">LGBT issues</div>
        <?php
            $per_page = 10;
            $pages_query = mysqli_query($conn, 'SELECT id FROM petition WHERE category = "LGBT issues"');
            ...
            $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE category = "LGBT issues" ORDER BY id DESC LIMIT ' . $start . ',' . $per_page . '';
