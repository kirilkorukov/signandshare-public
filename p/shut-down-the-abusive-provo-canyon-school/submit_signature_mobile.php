<?php
    ...
    if($_POST){
        ...
        $firstName = mysqli_real_escape_string($conn,$_POST['firstNameMobile']);
        $lastName = mysqli_real_escape_string($conn,$_POST['lastNameMobile']);
        $email = mysqli_real_escape_string($conn,$_POST['emailMobile']);
        $country = mysqli_real_escape_string($conn,$_POST['countryMobile']);
        $city = mysqli_real_escape_string($conn,$_POST['cityMobile']);
        $reasonForSigning = mysqli_real_escape_string($conn,$_POST['reasonForSigningMobile']);
        if(isset($_POST['davaiMobile'])){
            $public = 0;
        }
        else{
            $public = 1;
        ...
        $checkGoalSupporters = 'SELECT currentSupporters, goalSupporters FROM petition WHERE id = ' . $petitionId;
        ...
        if(isset($_SESSION['isLogged'])){
            ...
            $isCountrySet = $_POST['isCountrySetMobile']; 
            $isCitySet = $_POST['isCitySetMobile'];
