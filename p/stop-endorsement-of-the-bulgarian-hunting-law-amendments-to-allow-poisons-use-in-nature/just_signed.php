...
<main class="index-page-wrapper">
    ...
    <div class="left-column" style="margin-left: auto; margin-right: auto;">
        ...
        <div class="thank-you-small-title" style="margin-top: 40px;">2. Sign more petitions</div>
            <?php
                $mysql = 'SELECT title, image, path, currentSupporters, byWho, target, victory FROM petition WHERE featured = 1 AND closed = 0 AND victory = 0 AND id != ' . $petitionId .' ORDER BY id DESC LIMIT 6';
